<x-app-layout>
    ...
    <section class="relative z-10 overflow-hidden py-20 lg:py-[120px] text-black dark:text-white">
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12 self-center">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">(+880) 1823744169</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base"> prantobd320@gmail.com </p>
                            </div>
                        </div>
                    </div>
                </div>
