<x-app-layout>
    ...
    <div class="max-w-4xl  mx-auto  m-2 bg-gray-200 p-4 rounded-md dark:bg-gray-800">
        ...
        <h2 class="text-2xl underline">WordPress Websites </h2> <h4 class="italic text-red-600">Click to View</h4>
    ...
    <div class="max-w-4xl mx-auto m-2 bg-gray-200 p-4 rounded-md dark:bg-gray-800">
        <h2 class="text-2xl underline">Frontend / Elementor</h2> <h4 class="italic text-red-600">Click to View</h4>
        <div class="grid  grid-cols-1 md:grid-cols-2 gap-4 p-4">
    ...
    <div class="max-w-4xl mx-auto m-2 bg-gray-200 p-4 rounded-md dark:bg-gray-800">
        <h2 class="text-2xl underline">Laravel Sites</h2> <h4 class="italic text-red-600">Click to View</h4>
        <div class="grid  grid-cols-1 md:grid-cols-2 gap-4 p-4">
    ...
    <div class="max-w-4xl mx-auto m-2 bg-gray-200 p-4 rounded-md dark:bg-gray-800">
        <h2 class="text-2xl underline">Newspaper Site</h2> <h4 class="italic text-red-600">Click to View</h4>
        <div class="grid  grid-cols-1 md:grid-cols-2 gap-4 p-4">
            <a target="_blank" href="https://techland360.com">https://techland360.com</a>
            <a target="_blank" href="https://deheza.co.uk">https://deheza.co.uk</a>
